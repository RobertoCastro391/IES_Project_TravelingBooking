...
const FlightsSearch = () => {
  ...
  const fetchFlights = async () => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/flights/searchFlight`, {
        method: 'POST',
        headers: {
  ...
  const fetchYourAirportsAPI = async () => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/flights/airports`);
