...
public class TrainsReservationDTO {
    ...
    public void setTrainNumberOutbound(String trainNumberOutbound) {
        this.trainNumberOutbound = trainNumberOutbound;
    }

    public String getTrainNumberInbound() {
        return trainNumberInbound;
    }

    public void setTrainNumberInbound(String trainNumberInbound) {
        this.trainNumberInbound = trainNumberInbound;
    }
